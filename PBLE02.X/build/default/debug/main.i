...
void main(void) {
    ...
    for (;;) {
        lcdCommand(0x80);
        lcdData((((bcd2dec(dsReadData(2)& 0x5f)) / 10) % 10) + 48);
        lcdData(((bcd2dec(dsReadData(2)& 0x5f)) % 10) + 48);
        lcdData(':');
        lcdData((((bcd2dec(dsReadData(1)& 0x7f)) / 10) % 10) + 48);
        lcdData(((bcd2dec(dsReadData(1)& 0x7f)) % 10) + 48);
        lcdData(':');
        lcdData((((bcd2dec(dsReadData(0)& 0x7f)) / 10) % 10) + 48);
        lcdData(((bcd2dec(dsReadData(0)& 0x7f)) % 10) + 48);
