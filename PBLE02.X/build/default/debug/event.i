        ...
        if (data == 'p') {
            if (reading_protocol == 0) {
                ...
                for (char i = reading_protocol - 3; i > 0; i--) {
                    ...
                    serialSend(i + '0');
                    serialSendInt((msg[i] - '0') * pow10(reading_protocol - 3 - i));
                    serialSendString("     ");
                }
                msg[reading_protocol - 2] = '0';
                if (msg[0] == 'H') {
                    setHOUR((msg[5] - 48)*10000 + (msg[4] - 48)*1000 + (msg[3] - 48)*100 + (msg[2] - 48)*10 + (msg[1] - 48));
                }

                if (msg[0] == 'M') {
                    setMIN((msg[5] - 48)*10000 + (msg[4] - 48)*1000 + (msg[3] - 48)*100 + (msg[2] - 48)*10 + (msg[1] - 48));
                }

                if (msg[0] == 'S') {
                    setSEC((msg[5] - 48)*10000 + (msg[4] - 48)*1000 + (msg[3] - 48)*100 + (msg[2] - 48)*10 + (msg[1] - 48));
                }

                if (msg[0] == 'L') {
                    setLanguage(((msg[1] - 48)*10000 + (msg[2] - 48)*1000 + (msg[3] - 48)*100 + (msg[4] - 48)*10 + (msg[5] - 48)) % 2);
                }

                if (msg[0] == 'A') {
                    setAlarmUpperLevel((msg[1] - 48)*10000 + (msg[2] - 48)*1000 + (msg[3] - 48)*100 + (msg[4] - 48)*10 + (msg[5] - 48));
                }

                if (msg[0] == 'a') {
                    setAlarmLowerLevel((msg[1] - 48)*10000 + (msg[2] - 48)*1000 + (msg[3] - 48)*100 + (msg[4] - 48)*10 + (msg[5] - 48));
                }
                static char envio[7];
                for (char i = 0; i < 6; i++) {
                    envio[i] = msg[i];
                ...
                msg[6] = '\0';
                serialSendString(envio);
                serialSend(' ');
                serialSend(reading_protocol + '0');
                serialSend(' ');
                serialSendInt(value);
                serialSend(' ');
                reading_protocol = 0;
